...
export const GLOSSARY: GlossaryTerm[] = [
  { term: "Symbol", def: "A function, method, or class Legend extracted from your code. Each carries its name, kind, docstring, complexity, and the other symbols it calls. The diagrams are built from symbols (nodes) and their calls (edges)." },
  ...
  { term: "Endpoints / Routes", def: "HTTP routes Legend detected (method + path) — the API surface of a web codebase. Shown in the API & DB tab." },
