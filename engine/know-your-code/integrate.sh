#!/usr/bin/env bash
# integrate.sh — run from the know-your-code/ module folder, against the parent Orchestraty repo.
...
FRONTEND_DIR="know-your-code"    # Frontend folder name (hyphens; TS uses relative imports)
ROOT="$(cd .. && pwd)"

echo "▶ Integrating Know Your Code into: $ROOT"
[ -f "$ROOT/app.py" ] || { echo "✗ $ROOT/app.py not found. Run this from know-your-code/ inside ai-operating-system/."; exit 1; }
...
# 3. Frontend -> frontend/Frontend/src/modules/know-your-code/
...
echo "  3. Navbar.tsx ........... add the 'Know Your Code' nav item"
